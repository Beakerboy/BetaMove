...
def handStringSeqGeneratorForAllProblem(processed_data, save_path, print_result = False):
    """
    Apply moveGenerator on all problems, and transform the output into X vector move sequence for RNN
    Input:
    - processed_data: the processed data that is scraped from MoonBoard
    ...
    Output:
    dictionary-- key: handSeqList
    i.e.
    ["J5-LH", "G6-RH" ...."D18-RH"]. This sequence will be feed into RNN as hand seq corps to train route generator
    """
    output = {}
    list_fail = []
